...
# b = FootSetUp(guide_foot_loc = ['l__leg_ankle__loc__', 'l__leg_ball__loc__', 'l__leg_toe__loc__', 'l__leg_heel__loc__'])            
# b.FootToLeg('l__Leg__ankle_ik__jnt__','l__Leg__IkHandle__','l__Leg_IK__ctrl__','l__Leg_IK_offset__ctrl__','l__Leg_Options__ctrl__','l__Leg__ankle_fk__ctrl__')    
