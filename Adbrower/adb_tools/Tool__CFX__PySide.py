...
from adbrower import flatList, lprint
...
class cfxToolbox(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    ...
    # --------- Layouts
        ...
        # ----- For Original start/end section
        self.text_top_layout=QtWidgets.QGridLayout()
        ...
        # ----- For Refresh and Reset Buttons
        self.cameraFunctions_Hlayout=QtWidgets.QHBoxLayout()
        ...
        self.presetListLeft.setSelectionMode(
            QtWidgets.QAbstractItemView.ExtendedSelection)
        self.presetListLeft.setMaximumHeight(100)
        # ---- add Alls cameras
        [self.presetListLeft.addItem(cam) for cam in self.allCam]
        self.presetListLeft.itemDoubleClicked.connect(
            self.doubleClickedCamLeft)

        self.presetListRight=QtWidgets.QListWidget()
        self.presetListRight.setMaximumHeight(100)
        self.presetListRight.setSelectionMode(
            QtWidgets.QAbstractItemView.ExtendedSelection)
        self.presetListRight.itemDoubleClicked.connect(
            self.doubleClickedCamRight)
        ...
        # QCheckBox
        self.bls_checkbx=QtWidgets.QCheckBox(
            'Blend blendshape position / world')
        self.bls_checkbx.setStyleSheet(
            "color:{}; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;".format(pysideColorDic['colorLightGrey']))

        # QLineEdit
        self.originalStartFrame_LineEdit=QtWidgets.QLineEdit(
            str(self.Original_startTime_value))
        self.originalStartFrame_LineEdit.setMaximumSize(QtCore.QSize(50, 20))
        self.originalStartFrame_LineEdit.editingFinished.connect(
            self.OriginalStartFrameCC)

        self.originalEndFrame_LineEdit=QtWidgets.QLineEdit(
            str(self.Original_endTime))
        self.originalEndFrame_LineEdit.setMaximumSize(QtCore.QSize(50, 20))
        self.originalEndFrame_LineEdit.editingFinished.connect(
            self.OriginalEndFrameCC)
    ...
    def create_Button(self):
        ...
        self.buttonAndFunctions=[
                ...
                ['Set Timeslider for Caches',   self.cachesTimeSlider,       1,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.button_top_layout,              ''],
                ['Reset Timeslider',            self.reset,                  1,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.button_top_layout,              ''],

                ['Clean View  ',                self.cleanViewer,            2,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.playblastFrame,                 ''],
                ['Playblast',                   self.playbast_org,           2,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.playblastFrame,                 ''],
                ['Playblast Rewrite',           self.playbast_re,            2,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.playblastFrame,                 ''],
                ['Playblast NEW VERSION',       self.playbast_ver,           2,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorGreen3'],      self.playblastFrame,                 ''],
                ['...',                         self.selectPath,             2,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.path_layout,                    ''],

                ['Expand / Collapse All',       self.expandAll,              2,    pysideColorDic['colorBlue'],
                    pysideColorDic['colorDarkGrey3'],   self.bottons_layout,                 ''],
                ...
                ['Refresh',                     self.refreshCam,             3,    pysideColorDic['colorLightGrey'],
                ...
                ['Key',                         self.keyBls,                 4,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.blendshapeButton_layout,        ''],
                ...
                ['Blend 2 Group',               self.blend2GrpBls,           4,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.utilsFrame,                     ''],
                ['Delete BLS',                  self.deleteBls,              4,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.utilsFrame,                     ''],
                ['Sticky From Face',            adbRivet.sticky_from_faces,  4,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.utilsFrame,                     ''],

                ['Cloth Manager UI',            self.clothManagerAB,         5,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.clothFunctions_layout,          ''],
                ['Duplicate Special',           self.duplicateSpecial,       5,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.clothFunctions_layout,          ''],
                ['Make Cloth',                  self.makeCloth,              5,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.clothFunctions_doublelayout,    '0,0'],
                ['Rename Cloth',                self.renameCloth,            5,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.clothFunctions_doublelayout,    '0,1'],
                ['Make Rigid',                  self.makeRigid,              5,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.clothFunctions_doublelayout,    '1,0'],
                ['Rename Rigid',                self.renameRigid,            5,    pysideColorDic['colorLightGrey'],
                    pysideColorDic['colorDarkGrey3'],   self.clothFunctions_doublelayout,    '1,1'],
                                ]
        ...
        for buttonName, buttonFunction, _, labColor, bgColor, layout, layout_coord, in self.buttonAndFunctions:
            ...
            try:
                layout.addWidget(self.buttons[buttonName], int(
                    layout_coord.split(',')[0]), int(layout_coord.split(',')[1]))
            except ValueError:
        ...
        # ## Grouping Buttons
        self.buttons1=[button for button, _, groupNumber, labColor, bgColor,
            layout, layout_coord in self.buttonAndFunctions if groupNumber == 1]
        self.buttons2=[button for button, _, groupNumber, labColor, bgColor,
            layout, layout_coord in self.buttonAndFunctions if groupNumber == 2]
        self.buttons3=[button for button, _, groupNumber, labColor, bgColor,
            layout, layout_coord in self.buttonAndFunctions if groupNumber == 3]
        self.buttons4=[button for button, _, groupNumber, labColor, bgColor,
            layout, layout_coord in self.buttonAndFunctions if groupNumber == 4]
        self.buttons5=[button for button, _, groupNumber, labColor, bgColor,
            layout, layout_coord in self.buttonAndFunctions if groupNumber == 5]


    def populate(self):
        """ Populate the TreeQ Widget """
        self.playRoots=[QtWidgets.QTreeWidgetItem(
            self.playTree, [str(item)]) for item in self.roots]
    ...
    def cachesTimeSlider(self):
        ...
        if endFrame == endFrameTimeS:
            mc.playbackOptions(e=True, animationStartTime=970, minTime=970,
                               animationEndTime=endFrame + 1, maxTime=endFrame + 1)
            ...
            mc.playbackOptions(e=True, minTime=1001,
                               animationEndTime=endFrame, maxTime=endFrame)
            self.buttons['Set Timeslider for Caches'].setStyleSheet(
    ...
    def deleteSelectedPlayblast(self):
        ...
        update_data=self.getOsDatas()
        update_root=self.getRootsData()
        update_playRoots=[QtWidgets.QTreeWidgetItem(
            self.playTree, [str(item)]) for item in update_root]
    ...
    def removeCam(self):
        ...
        _oldcameras=[self.presetListRight.item(
            index).text() for index in range(numb)]
    ...
    def keyBls(self):
        ...
        all_weight_name=[weight_name[index]
            for index in range(0, len(pm.selected()))]
    ...
    def duplicateSpecial(self):
        for each in pm.selected():
            dup_mesh=pm.duplicate(
                each, inputConnections=True, returnRootsOnly=True)[0]
            ...
            attr=dup_mesh + '.v'
            mel.eval(
                "source channelBoxCommand; CBdeleteConnection \"{}\"".format(attr))
            pm.select(None)
...
class clothManager(MayaQWidgetDockableMixin, QtWidgets.QDialog):
    ...
    def create_Button(self):
        ...
        self.buttonAndFunctions=[
                ...
                ['Expand All',   self.expandAll,   pysideColorDic['colorYellowlabel'],
                    pysideColorDic['colorDarkGrey3'],   self.bottons_layout, ]]
    ...
    def qTreeSetup(self):
        ...
        self.nucRoots=[QtWidgets.QTreeWidgetItem(
            self.clothTree, [str(item)]) for item in self.all_necleus]
    ...
    def populate(self):
        ...
        for nuc in self.all_necleus:
            _connectionCloth=list(
                set(pm.listConnections(nuc, s = True, d = False)))
            __connectionCloth=[
                x for x in _connectionCloth if 'time' not in str(x)]
            connectionCloth=[
                x for x in __connectionCloth if getType(x) == 'nCloth']
        ...
        for _index in range(len(self.all_necleus)):
            for cloth in nucDictCloth[str(self.all_necleus[_index])]:
                ...
                children=[_root.child(index) for index in range(
                    child_count)]  # = nRigid, nCloth, constraint
        ...
        nucDictRigid={}
        for nuc in self.all_necleus:
            _connectionRigid=list(
                set(pm.listConnections(nuc, s = True, d = False)))
            __connectionRigid=[
                x for x in _connectionRigid if 'time' not in str(x)]
            connectionRigid=[
                x for x in __connectionRigid if getType(x) == 'nRigid']
        ...
        nucDictCons={}
        for nuc in self.all_necleus:
            _connectionCons=list(
                set(pm.listConnections(nuc, s = True, d = False)))
            __connectionCons=[
                x for x in _connectionCons if 'time' not in str(x)]
            connectionCons=[x for x in __connectionCons if getType(
                x) == 'dynamicConstraint']
